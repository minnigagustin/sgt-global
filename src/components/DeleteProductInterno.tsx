...
const DeleteProductInterno = ({
  ...
  const handleDelete = async () => {
    try {
      await AxiosUrl.delete(`productos_internos_api.php?id=${item.id}`);
  ...
  return (
    ...
    >
      ...
      <AlertDialogContent>
        ...
        <AlertDialogCloseButton />
        <AlertDialogBody>
          Estas seguro de eliminar este producto interno? Se eliminara
          permanentemente.
        </AlertDialogBody>
        <AlertDialogFooter>
...
export default DeleteProductInterno;
